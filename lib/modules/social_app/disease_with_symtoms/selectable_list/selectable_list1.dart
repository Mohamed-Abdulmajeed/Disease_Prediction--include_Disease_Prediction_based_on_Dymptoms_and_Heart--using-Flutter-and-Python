...
class SelectableList1 extends StatefulWidget {
  const SelectableList1({super.key});
  @override
  State<SelectableList1> createState() => _SelectableList1State();
}

class _SelectableList1State extends State<SelectableList1> {
    ...
    return SelectableList<Person, String?>(
      ...
      onItemSelected: (person) {
        setState(() {
          ...
          SocialCubit.get(context).AddValueOfSymptom1(selectedName!);
        });
      },
