...
class SelectableList3 extends StatefulWidget {
  const SelectableList3({super.key});
  @override
  State<SelectableList3> createState() => _SelectableList3State();
}

class _SelectableList3State extends State<SelectableList3> {
    ...
    return SelectableList<Person, String?>(
      ...
      onItemSelected: (person) {
        setState(() {
          ...
          SocialCubit.get(context).AddValueOfSymptom3(selectedName!);
        });
      },
