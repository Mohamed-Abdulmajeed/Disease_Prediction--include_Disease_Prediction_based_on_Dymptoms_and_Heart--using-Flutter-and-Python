...
class SelectableList4 extends StatefulWidget {
  const SelectableList4({super.key});
  @override
  State<SelectableList4> createState() => _SelectableList4State();
}

class _SelectableList4State extends State<SelectableList4> {
    ...
    return SelectableList<Person, String?>(
      ...
      onItemSelected: (person) {
        setState(() {
          ...
          SocialCubit.get(context).AddValueOfSymptom4(selectedName!);
        });
      },
