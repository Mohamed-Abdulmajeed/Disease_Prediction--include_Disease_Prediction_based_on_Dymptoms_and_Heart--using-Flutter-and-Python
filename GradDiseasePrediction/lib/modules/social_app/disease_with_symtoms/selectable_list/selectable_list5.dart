...
class SelectableList5 extends StatefulWidget {
  const SelectableList5({super.key});
  @override
  State<SelectableList5> createState() => _SelectableList5State();
}

class _SelectableList5State extends State<SelectableList5> {
    ...
    return SelectableList<Person, String?>(
      ...
      onItemSelected: (person) {
        setState(() {
          ...
          SocialCubit.get(context).AddValueOfSymptom5(selectedName!);
        });
      },
